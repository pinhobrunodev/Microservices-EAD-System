...
public class NotificationConsumer {
    ...
    public NotificationConsumer(NotificationModelService notificationModelService) {
    ...
    public void listenUserEvent(@Payload NotificationCommandDto notificationCommandDto) {
        ...
        notificationModel.setCreationDate(LocalDateTime.now());
        notificationModel.setNotificationStatus(NotificationStatus.CREATED);
        notificationModelService.saveNotification(notificationModel); // Always when receive the notificationCommandDto will convert and save notification to a spec user.
    }
